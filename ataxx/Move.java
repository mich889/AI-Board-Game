...
class Move {
    ...
    private Move(int col0, int row0, int col1, int row1) {
        ...
        _isJump = abs(col1 - col0) == 2 || abs(row1 - row0) == 2;
        boolean notJump = !_isJump;
        _isExtend = (abs(col1 - col0) == 1 || abs(row1 - row0) == 1) && notJump;
    ...
    public String toString() {
        if (isPass()) {
            ...
            String firstCoord = ("" + _col0) + ("" + _row0);
            return (firstCoord + '-' + ("" + _col1) + ("" + _row1));
        }
    }
